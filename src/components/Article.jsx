...
import EcomWidgetProductGrid from './EcomWidgetProductGrid'
        ...
        <div className="story_hero_hero_container">
          <div className="story_hero_text_container">
            ...
            <h1 className="story_hero_title">
              Rolls-Royce Cullinan Cosmos is the First Rolls-Royce in History to
              have a Hand-Painted Inner Roof
            </h1>
            ...
            <div className="story-main-wrapper">
              <p style={{ textAlign: "justify" }}>
                <span style={{ color: "rgb(0, 0, 0)" }}>
                  ...
                  Cullinan Cosmos, only one of which has been commissioned. This
                ...
                <span style={{ color: "rgb(0, 0, 0)" }}>
                  {" "}
                  in history to have an inner roof that’s entirely hand-painted.{" "}
                </span>
              </p>
              <p style={{ textAlign: "justify" }} />
              <p style={{ textAlign: "justify" }}>
                <span style={{ color: "rgb(0, 0, 0)" }}>
                  The headliner (inner, fabric-covered roof) took over 160 hours
                  to be completed, and this task was carried out by one of
                  Rolls-Royce’s resident artists. This car was commissioned by a
                  family fascinated by astronomy and space and ordered through
                  the carmaker’s Dubai office.
                </span>
              ...
              <p style={{ textAlign: "justify" }}>
                <span style={{ color: "rgb(0, 0, 0)" }}>
                  Handcrafted is the keyword here. As soon as you step into the
                  cabin of the Cullinan Cosmos, it feels like you are floating
                  in outer space, thanks to its visual and tactile design. The
                  custom Rolls-Royce colours used inside are Charles Blue and
                  Grace White leather, complemented by glossy Piano White
                  veneers that allude to the shiny surfaces of space satellites.
                </span>
                <span style={{ color: "inherit" }}>&nbsp;</span>
                <span style={{ color: "rgb(0, 0, 0)" }}>
              ...
              <p style={{ textAlign: "justify" }}>
                <span style={{ color: "rgb(0, 0, 0)" }}>
                  ...
                  looking up can see the Milky Way, replete with constellations
                  and misty accents. The artist worked with acrylic paints and a
                  multitude of brushes to add texture and depth to the artwork.
                  He then used a special brush to finish the overall piece with
                  a field of twinkling stars. Once the entire painting was
                  completed, the craftsmen perforated it by hand to add the
                  fibre optics to add the light effect. The mist was created by
                  delicately applying paint with a makeup brush.
                </span>
              </p>
              <div>
                <div
                ...
                >
                  <div className="story-hoverDiv" style={{ width: "100%" }}>
                    ...
                    <div className="story-photoBy">
                      <span className="story-caption">
                        The exterior glows in Arabescato Pearl with twin Charles
                        Blue coach lines.
                      </span>
                      <span className="story-courtesy">
                        Image courtesy: Rolls Royce
              ...
              <p style={{ textAlign: "justify" }}>
                <span style={{ color: "rgb(0, 0, 0)" }}>
                  The outside of the car is in Arabescato Pearl, as a reference
                  to the moonlight. The Charles Blue that you find inside the
                  cabin is mirrored on the outside as a twin coach line.
                </span>
                <span style={{ color: "inherit" }}>&nbsp; </span>
                <span style={{ color: "rgb(0, 0, 0)" }}>
                  This project, as Rolls-Royce Motor Cars’ Head of Bespoke, Phil
                  Fabre de la Grange describes it, “explores new frontiers with
                  our first ever hand-painted Starlight Headline.”
                </span>
              </p>
              <div>
                <div className="ad-flex-all">
              ...
              <p style={{ textAlign: "justify" }}>
                <span style={{ color: "rgb(0, 0, 0)" }}>
                  ...
                  consistently promoting the art of handmade and the culture of
                  bespoke, it has got to be Rolls-Royce.
                </span>
              </p>
<EcomWidgetProductGrid />
              ...
              >
                <div className="relatedPost_relatedPostWrapper__0ZH_b">
                  <h2 className="relatedPost_relatedPostHeading__4l3Uo">
                    You may also like
                  </h2>
                  <div
                    className="relatedPost_grid__vaHGq"
                    style={{ width: "100%" }}
                  >
                    <a
                      target="_blank"
                    ...
                    >
                      ...
                      <div className="w-full bg-red-100">
                        <h3 className="relatedPost_card-title__PUoWX">
                          Bentley's New Address: Brand Bentley Officially Rolls
                          Into India
                        </h3>
                        <span className="relatedPost_category__xvCra">
                          Cars
                  ...
                  <div className="story_interesting_classname_container">
                    ...
                    >
                      ...
                      <div className="story_interesting_classname_text">
                        ...
                        <p className="story_interesting_classname_description">
                          In Conversation With Yohan Poonawalla: The Classic Car
                          Collector Who Owns Over 50 Rare Automobiles{" "}
                        </p>
                      </div>
                    </a>
                  </div>
                  ...
                  <div className="story_interesting_classname_container">
                    ...
                    >
                      ...
                      <div className="story_interesting_classname_text">
                        ...
                        <p className="story_interesting_classname_description">
                          6 Decades of Volante: Aston Martin Celebrates with 60
      ...
      <div>
        <div className="share__content">
          <div className="share_body">
            <span role="button" className="share-close-btn">
              <svg
                stroke="currentColor"
                fill="none"
                strokeWidth={2}
            ...
            <div className="share__icons">
              <a
                ...
                href="https://wa.me/?text=https%3A%2F%2Fwww.robbreportindia.com%2Fmotoring%2Fcars%2Fthis-one-of-one-commission-rolls-royce-cullinan-gets-its-first-ever-hand-painted-roof"
              >
                <svg
                  stroke="currentColor"
                  fill="currentColor"
              ...
              <a
                ...
                rel="noopener noreferrer"
                className="share__icon"
                href="https://twitter.com/intent/tweet?url=https%3A%2F%2Fwww.robbreportindia.com%2Fmotoring%2Fcars%2Fthis-one-of-one-commission-rolls-royce-cullinan-gets-its-first-ever-hand-painted-roof"
              >
                <svg
                  stroke="currentColor"
                  fill="currentColor"
              ...
              <a
                ...
                rel="noopener noreferrer"
                className="share__icon"
                href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fwww.robbreportindia.com%2Fmotoring%2Fcars%2Fthis-one-of-one-commission-rolls-royce-cullinan-gets-its-first-ever-hand-painted-roof"
              >
                <svg
                  stroke="currentColor"
                  fill="currentColor"
            ...
            <div className="">
              <div className="link_copycntr">
                <input
                  ...
                  readOnly=""
                  type="text"
                  defaultValue="https://www.robbreportindia.com/motoring/cars/this-one-of-one-commission-rolls-royce-cullinan-gets-its-first-ever-hand-painted-roof"
                />
                <svg
                  stroke="currentColor"
                  fill="none"
